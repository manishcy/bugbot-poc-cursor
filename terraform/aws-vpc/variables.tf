...
variable "availability_zones" {
  description = "List of Availability Zones to spread subnets across. Exactly two must be provided."
  type        = list(string)
...
variable "ingress_cidr_blocks" {
  description = "CIDR blocks allowed to reach the web server on HTTP/HTTPS."
  type        = list(string)
  default     = ["0.0.0.0/0"]
}
